        ...
        if (retJSON['header'].commodityItem) {
            ...
            requisitionSummary.collectEntries() {
                [it.commodityItem, [
                        ...
                        commodityTotal                        : ((it.commodityUnitPrice ?: 0.0) * (it.commodityQuantity ?: 0.0)).setScale( FinanceProcurementConstants.DECIMAL_PRECISION, BigDecimal.ROUND_HALF_UP ) + (it.commodityTaxAmount ?: 0.0) + (it.commodityAdditionalChargeAmount ?: 0.0)
                                - (it.commodityDiscountAmount ?: 0.0),
                        commodityTotalDisplay                 : FinanceProcurementHelper.getLocaleBasedFormattedNumber( ((it.commodityUnitPrice ?: 0.0) * (it.commodityQuantity ?: 0.0)).setScale( FinanceProcurementConstants.DECIMAL_PRECISION, BigDecimal.ROUND_HALF_UP ) + (it.commodityTaxAmount ?: 0.0) + (it.commodityAdditionalChargeAmount ?: 0.0)
