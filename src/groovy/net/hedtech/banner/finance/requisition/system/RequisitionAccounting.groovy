...
class RequisitionAccounting implements Serializable {

    /**
     * Surrogate ID for FPRREQA
     */
    @Id
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_SURROGATE_ID)
    @SequenceGenerator(name = FinanceProcurementConstants.REQ_ACC_GEN_FPVREQA_SEQ_GEN, allocationSize = 1,
            sequenceName = FinanceProcurementConstants.REQ_ACC_SEQ_FPVREQA_SURROGATE_ID_SEQUENCE)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = FinanceProcurementConstants.REQ_ACC_GEN_FPVREQA_SEQ_GEN)
    Long id
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_REQH_CODE)
    String requestCode

    /**
     * ITEM:  The system generated item number which specifies the commodity on the    requisition.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ITEM)
    Integer item

    /**
     * SEQUENCE NUMBER:  A system generated sequence number relating to transaction    within a document.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_SEQ_NUM)
    Integer sequenceNumber

    /**
     * Activity Date
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ACTIVITY_DATE)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_USER_ID)
    String userId

    /**
     * PERCENTAGE:  The discount percentage.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_PCT)
    BigDecimal percentage

    /**
     * REQUISITION AMOUNT:  The dollar amount for the specific requisition accounting  sequence.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_AMT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_COAS_CODE)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ACCI_CODE)
    String accountIndex

    /**
     * FUND CODE:  A code which uniquely identifies a fiscal entity.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_FUND_CODE)
    String fund

    /**
     * ORGANIZATION CODE:  Identifies the individual organization code which appears   on a transaction.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ORGN_CODE)
    String organization

    /**
     * ACCOUNT CODE:  The user-defined value representing an account.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ACCT_CODE)
    String account
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_PROG_CODE)
    String program
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ACTV_CODE)
    String activity
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_LOCN_CODE)
    String location
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_SUSP_IND)
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_NSF_SUSP_IND)
    Boolean nsfSuspInd
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CANCEL_IND)
    Boolean cancelIndicator

    /**
     * CANCELLATION DATE:  The date that the check was cancelled.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CANCEL_DATE)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_PROJ_CODE)
    String project
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_APPR_IND)
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_NSF_OVERRIDE_IND)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ABAL_IND)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CONVERTED_AMT)
     ...
     */
    @Type(type = "yes_no")
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CLOSED_IND)
    Boolean closedIndicator

    /**
     * DISCOUNT AMOUNT: The dollar value of the discount being taken on the invoice.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_DISC_AMT)
    BigDecimal discountAmount

    /**
     * TAX AMOUNT: The amount of tax computed or entered for a commodity.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_TAX_AMT)
    BigDecimal taxAmount

    /**
     * ADDITIONAL CHARGE AMOUNT: The amount of additional charges for the commodity record.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ADDL_CHRG_AMT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CONVERT_DISC_AMT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CONVERT_TAX_AMT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_CONVERT_ADDL_CHRG_AMT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_DISC_AMT_PCT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ADDL_AMT_PCT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_TAX_AMT_PCT)
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_DISC_RUCL_CODE)
    String discountRuleClass

    /**
     * TAX RULE CLASS CODE: The rule class code which is used for posting the accounting event for taxes.
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_TAX_RUCL_CODE)
    String taxRuleClass
     ...
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_ADDL_RUCL_CODE)
    String additionalChargeRuleClass

    /**
     * LIQUIDATION RULE CLASS CODE:
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_RUCL_CODE_LIQ)
     ...
     */
    @Version
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_VERSION)
    Long version

    /**
     * Data Origin column for FPRREQA
     */
    @Column(name = FinanceProcurementConstants.REQ_ACC_FIELD_FPVREQA_DATA_ORIGIN)
    String dataOrigin
