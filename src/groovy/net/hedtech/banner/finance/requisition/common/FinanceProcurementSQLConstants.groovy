...
final class FinanceProcurementSQLConstants {
     ...
     */
    public static
    final String QUERY_UPDATE_NEXT_REQ_SEQUENCE = "UPDATE FOBSEQN SET FOBSEQN_MAXSEQNO_7 = FOBSEQN_MAXSEQNO_7 + 1 WHERE FOBSEQN_SEQNO_TYPE = 'R'"
    /**
     * This constant is used to get query for to get generated request code.
     */
    public static
    final String QUERY_NEXT_REQ_NUMBER = "SELECT FOBSEQN_SEQNO_PREFIX||LPAD(TO_CHAR(FOBSEQN_MAXSEQNO_7),7,'0') AS NEXT_REQ_NUMBER FROM FOBSEQN WHERE FOBSEQN_SEQNO_TYPE = 'R'"
    /**
