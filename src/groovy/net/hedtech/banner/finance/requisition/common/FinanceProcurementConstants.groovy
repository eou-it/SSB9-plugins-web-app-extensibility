...
class FinanceProcurementConstants {
    ...
    static final String REQUISITION_INFO_SEARCH_PARAM_TRIMMED_SPACES = 'trimmedSearchParam'
    ...
    static final String REQUISITION_SUMMARY_FIELD_FPBREQH_USER_ID = 'FPBREQH_USER_ID'
    static final String REQUISITION_SUMMARY_FIELD_FPBREQH_CURR_CODE = 'FPBREQH_CURR_CODE'
    ...
    static final String REQUISITION_SUMMARY_FIELD_FPVVEND_SPRADDR_STREET_LINE2 = 'FPVVEND_SPRADDR_STREET_LINE2'
    static final String REQUISITION_SUMMARY_FIELD_FPVVEND_SPRADDR_STREET_LINE3 = 'FPVVEND_SPRADDR_STREET_LINE3'
    ...
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_SEQNO = 'GURTKLR_SEQNO'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_ACTIVITY_DATE = 'GURTKLR_ACTIVITY_DATE'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_COMMENT = 'GURTKLR_COMMENT'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_CONFID_IND = 'GURTKLR_CONFID_IND'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_DATA_ORIGIN = 'GURTKLR_DATA_ORIGIN'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_IDEN_CODE = 'GURTKLR_IDEN_CODE'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_ITEM_REFNO = 'GURTKLR_ITEM_REFNO'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_PIDM = 'GURTKLR_PIDM'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_SOURCE = 'GURTKLR_SOURCE'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_STATUS = 'GURTKLR_STATUS'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_SYSTEM_IND = 'GURTKLR_SYSTEM_IND'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_TODO_DATE = 'GURTKLR_TODO_DATE'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_TODO_TIME = 'GURTKLR_TODO_TIME'
    static final String FINANCE_GENERAL_TICKLER_GURTKLR_VERSION = 'GURTKLR_VERSION'
