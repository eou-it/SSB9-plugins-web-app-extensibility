...
class FinanceProcurementConstants {
    ...
    static final String VIEW_FPVREQLIST = 'FPVREQLIST'
    static final String ERROR_MESSAGE_INVALID_BUCKET_TYPE = 'invalid.bucket.type'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_SURROGATE_ID = 'FPBREQH_SURROGATE_ID'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_AMOUNT = 'AMOUNT'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_REQUESTOR_NAME = 'REQUESTOR_NAME'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_VENDOR_NAME = 'VENDOR_NAME'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_TRANS_DATE = 'FPBREQH_TRANS_DATE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_REQUEST_DATE = 'REQUEST_DATE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_DELIVERY_DATE = 'DELIVERY_DATE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_USER_ID = 'FPBREQH_USER_ID'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_ORIGIN_CODE = 'FPBREQH_ORIGIN_CODE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_CURR_CODE = 'FPBREQH_CURR_CODE'

    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_ORGN_CODE = 'FPBREQH_ORGN_CODE'

    static final String REQUISITION_INFO_FIELD_FPVREQLIST_ORG_TITLE = 'ORG_TITLE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_COAS_CODE = 'FPBREQH_COAS_CODE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_VEND_PIDM = 'FPBREQH_VEND_PIDM'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_ACTIVITY_DATE = 'FPBREQH_ACTIVITY_DATE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_FPBREQH_SURROGATE_ID = 'FPBREQH_SURROGATE_ID'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_FPBREQH_CODE = 'FPBREQH_CODE'
    static final String REQUISITION_INFO_FIELD_FPVREQLIST_STATUS = 'STATUS'
