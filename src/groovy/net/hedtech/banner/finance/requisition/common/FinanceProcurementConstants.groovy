...
class FinanceProcurementConstants {
    ...
    static final def REQ_ACC_NAMED_QUERY_GET_LAST_SEQ = 'RequestAccounting.getLastSequenceNumberByRequestCode'
    static final def REQ_ACC_NAMED_QUERY_GET_LAST_ITEM = 'RequestAccounting.getLastItemNumberByRequestCode'
    static final def REQ_ACC_NAMED_QUERY_BY_CODE = 'RequestAccounting.fetchByRequestCodeItemAndSeq'
    static final def REQ_ACC_NAMED_QUERY_BY_USER = 'RequestAccounting.fetchByUser'
    static final def QUERY_PARAM_REQUISITION_ACCOUNTING_ITEM = 'item'
    static final def QUERY_PARAM_REQUISITION_ACCOUNTING_SEQ_NUM = 'sequenceNumber'
    static final def REQ_ACC_ENTITY_FPVREQA = 'FPVREQA'
    static final def REQ_ACC_FIELD_FPRREQA_SURROGATE_ID = 'FPRREQA_SURROGATE_ID'
    static final def REQ_ACC_GEN_FPRREQA_SEQ_GEN = 'FPRREQA_SEQ_GEN'
    static final def REQ_ACC_SEQ_FPRREQA_SURROGATE_ID_SEQUENCE = 'FPRREQA_SURROGATE_ID_SEQUENCE'
    static final def REQ_ACC_FIELD_FPRREQA_REQH_CODE = 'FPRREQA_REQH_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ITEM = 'FPRREQA_ITEM'
    static final def REQ_ACC_FIELD_FPRREQA_SEQ_NUM = 'FPRREQA_SEQ_NUM'
    static final def REQ_ACC_FIELD_FPRREQA_ACTIVITY_DATE = 'FPRREQA_ACTIVITY_DATE'
    static final def REQ_ACC_FIELD_FPRREQA_USER_ID = 'FPRREQA_USER_ID'
    static final def REQ_ACC_FIELD_FPRREQA_PCT = 'FPRREQA_PCT'
    static final def REQ_ACC_FIELD_FPRREQA_AMT = 'FPRREQA_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_FSYR_CODE = 'FPRREQA_FSYR_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_PERIOD = 'FPRREQA_PERIOD'
    static final def REQ_ACC_FIELD_FPRREQA_RUCL_CODE = 'FPRREQA_RUCL_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_COAS_CODE = 'FPRREQA_COAS_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ACCI_CODE = 'FPRREQA_ACCI_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_FUND_CODE = 'FPRREQA_FUND_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ORGN_CODE = 'FPRREQA_ORGN_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ACCT_CODE = 'FPRREQA_ACCT_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_PROG_CODE = 'FPRREQA_PROG_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ACTV_CODE = 'FPRREQA_ACTV_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_LOCN_CODE = 'FPRREQA_LOCN_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_SUSP_IND = 'FPRREQA_SUSP_IND'
    static final def REQ_ACC_FIELD_FPRREQA_NSF_SUSP_IND = 'FPRREQA_NSF_SUSP_IND'
    static final def REQ_ACC_FIELD_FPRREQA_CANCEL_IND = 'FPRREQA_CANCEL_IND'
    static final def REQ_ACC_FIELD_FPRREQA_CANCEL_DATE = 'FPRREQA_CANCEL_DATE'
    static final def REQ_ACC_FIELD_FPRREQA_PROJ_CODE = 'FPRREQA_PROJ_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_APPR_IND = 'FPRREQA_APPR_IND'
    static final def REQ_ACC_FIELD_FPRREQA_NSF_OVERRIDE_IND = 'FPRREQA_NSF_OVERRIDE_IND'
    static final def REQ_ACC_FIELD_FPRREQA_ABAL_IND = 'FPRREQA_ABAL_IND'
    static final def REQ_ACC_FIELD_FPRREQA_CONVERTED_AMT = 'FPRREQA_CONVERTED_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_CLOSED_IND = 'FPRREQA_CLOSED_IND'
    static final def REQ_ACC_FIELD_FPRREQA_DISC_AMT = 'FPRREQA_DISC_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_TAX_AMT = 'FPRREQA_TAX_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_ADDL_CHRG_AMT = 'FPRREQA_ADDL_CHRG_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_CONVERT_DISC_AMT = 'FPRREQA_CONVERT_DISC_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_CONVERT_TAX_AMT = 'FPRREQA_CONVERT_TAX_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_CONVERT_ADDL_CHRG_AMT = 'FPRREQA_CONVERT_ADDL_CHRG_AMT'
    static final def REQ_ACC_FIELD_FPRREQA_DISC_AMT_PCT = 'FPRREQA_DISC_AMT_PCT'
    static final def REQ_ACC_FIELD_FPRREQA_ADDL_AMT_PCT = 'FPRREQA_ADDL_AMT_PCT'
    static final def REQ_ACC_FIELD_FPRREQA_TAX_AMT_PCT = 'FPRREQA_TAX_AMT_PCT'
    static final def REQ_ACC_FIELD_FPRREQA_DISC_RUCL_CODE = 'FPRREQA_DISC_RUCL_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_TAX_RUCL_CODE = 'FPRREQA_TAX_RUCL_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_ADDL_RUCL_CODE = 'FPRREQA_ADDL_RUCL_CODE'
    static final def REQ_ACC_FIELD_FPRREQA_RUCL_CODE_LIQ = 'FPRREQA_RUCL_CODE_LIQ'
    static final def REQ_ACC_FIELD_FPRREQA_VERSION = 'FPRREQA_VERSION'
    static final def REQ_ACC_FIELD_FPRREQA_DATA_ORIGIN = 'FPRREQA_DATA_ORIGIN'
    static final def ERROR_MESSAGE_MISSING_REQUISITION_ACCOUNTING = 'missing.requisition.accounting'
    ...
    static final def REQUISITION_INFO_FIELD_FPVREQLIST_FPBREQH_CURR_CODE = 'FPBREQH_CURR_CODE'
