...
class FinanceProcurementConstants {
    ...
    static final String FIELD_FPRREQD_COPY_SURROGATE_ID = 'FPRREQD_SURROGATE_ID'
    static final String FIELD_FPRREQD_COPY_SEQ_GEN = 'FPRREQD_SEQ_GEN'
    static final String FIELD_FPRREQD_COPY_SURROGATE_ID_SEQUENCE = 'FPRREQD_SURROGATE_ID_SEQUENCE'
    static final String FIELD_FPRREQD_COPY_REQH_CODE = 'FPRREQD_REQH_CODE'
    static final String FIELD_FPRREQD_COPY_ITEM = 'FPRREQD_ITEM'
    static final String FIELD_FPRREQD_COPY_ACTIVITY_DATE = 'FPRREQD_ACTIVITY_DATE'
    static final String FIELD_FPRREQD_COPY_USER_ID = 'FPRREQD_USER_ID'
    static final String FIELD_FPRREQD_COPY_COMM_CODE = 'FPRREQD_COMM_CODE'
    static final String FIELD_FPRREQD_COPY_COMM_DESC = 'FPRREQD_COMM_DESC'
    static final String FIELD_FPRREQD_COPY_COAS_CODE = 'FPRREQD_COAS_CODE'
    static final String FIELD_FPRREQD_COPY_ORGN_CODE = 'FPRREQD_ORGN_CODE'
    static final String FIELD_FPRREQD_COPY_BUYR_CODE = 'FPRREQD_BUYR_CODE'
    static final String FIELD_FPRREQD_COPY_QTY = 'FPRREQD_QTY'
    static final String FIELD_FPRREQD_COPY_UOMS_CODE = 'FPRREQD_UOMS_CODE'
    static final String FIELD_FPRREQD_COPY_UNIT_PRICE = 'FPRREQD_UNIT_PRICE'
    static final String FIELD_FPRREQD_COPY_AGRE_CODE = 'FPRREQD_AGRE_CODE'
    static final String FIELD_FPRREQD_COPY_REQD_DATE = 'FPRREQD_REQD_DATE'
    static final String FIELD_FPRREQD_COPY_SHIP_CODE = 'FPRREQD_SHIP_CODE'
    static final String FIELD_FPRREQD_COPY_VEND_PIDM = 'FPRREQD_VEND_PIDM'
    static final String FIELD_FPRREQD_COPY_VEND_REF_NUM = 'FPRREQD_VEND_REF_NUM'
    static final String FIELD_FPRREQD_COPY_PROJ_CODE = 'FPRREQD_PROJ_CODE'
    static final String FIELD_FPRREQD_COPY_POHD_CODE = 'FPRREQD_POHD_CODE'
    static final String FIELD_FPRREQD_COPY_POHD_ITEM = 'FPRREQD_POHD_ITEM'
    static final String FIELD_FPRREQD_COPY_BIDS_CODE = 'FPRREQD_BIDS_CODE'
    static final String FIELD_FPRREQD_COPY_COMPLETE_IND = 'FPRREQD_COMPLETE_IND'
    static final String FIELD_FPRREQD_COPY_SUSP_IND = 'FPRREQD_SUSP_IND'
    static final String FIELD_FPRREQD_COPY_CANCEL_IND = 'FPRREQD_CANCEL_IND'
    static final String FIELD_FPRREQD_COPY_CANCEL_DATE = 'FPRREQD_CANCEL_DATE'
    static final String FIELD_FPRREQD_COPY_CLOSED_IND = 'FPRREQD_CLOSED_IND'
    static final String FIELD_FPRREQD_COPY_POST_DATE = 'FPRREQD_POST_DATE'
    static final String FIELD_FPRREQD_COPY_TEXT_USAGE = 'FPRREQD_TEXT_USAGE'
    static final String FIELD_FPRREQD_COPY_ATYP_CODE = 'FPRREQD_ATYP_CODE'
    static final String FIELD_FPRREQD_COPY_ATYP_SEQ_NUM = 'FPRREQD_ATYP_SEQ_NUM'
    static final String FIELD_FPRREQD_COPY_RECOMM_VEND_NAME = 'FPRREQD_RECOMM_VEND_NAME'
    static final String FIELD_FPRREQD_COPY_CURR_CODE = 'FPRREQD_CURR_CODE'
    static final String FIELD_FPRREQD_COPY_CONVERTED_UNIT_PRICE = 'FPRREQD_CONVERTED_UNIT_PRICE'
    static final String FIELD_FPRREQD_COPY_DISC_AMT = 'FPRREQD_DISC_AMT'
    static final String FIELD_FPRREQD_COPY_TAX_AMT = 'FPRREQD_TAX_AMT'
    static final String FIELD_FPRREQD_COPY_ADDL_CHRG_AMT = 'FPRREQD_ADDL_CHRG_AMT'
    static final String FIELD_FPRREQD_COPY_CONVERT_DISC_AMT = 'FPRREQD_CONVERT_DISC_AMT'
    static final String FIELD_FPRREQD_COPY_CONVERT_TAX_AMT = 'FPRREQD_CONVERT_TAX_AMT'
    static final String FIELD_FPRREQD_COPY_CONVERT_ADDL_CHRG_AMT = 'FPRREQD_CONVERT_ADDL_CHRG_AMT'
    static final String FIELD_FPRREQD_COPY_TGRP_CODE = 'FPRREQD_TGRP_CODE'
    static final String FIELD_FPRREQD_COPY_AMT = 'FPRREQD_AMT'
    static final String FIELD_FPRREQD_COPY_DESC_CHGE_IND = 'FPRREQD_DESC_CHGE_IND'
    static final String FIELD_FPRREQD_COPY_VERSION = 'FPRREQD_VERSION'
    static final String FIELD_FPRREQD_COPY_DATA_ORIGIN = 'FPRREQD_DATA_ORIGIN'
    ...
    static final String REQ_ACC_FIELD_COPY_FPRREQA_SURROGATE_ID = 'FPRREQA_SURROGATE_ID'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_REQH_CODE = 'FPRREQA_REQH_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ITEM = 'FPRREQA_ITEM'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_SEQ_NUM = 'FPRREQA_SEQ_NUM'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ACTIVITY_DATE = 'FPRREQA_ACTIVITY_DATE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_USER_ID = 'FPRREQA_USER_ID'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_PCT = 'FPRREQA_PCT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_AMT = 'FPRREQA_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_FSYR_CODE = 'FPRREQA_FSYR_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_PERIOD = 'FPRREQA_PERIOD'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_RUCL_CODE = 'FPRREQA_RUCL_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_COAS_CODE = 'FPRREQA_COAS_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ACCI_CODE = 'FPRREQA_ACCI_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_FUND_CODE = 'FPRREQA_FUND_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ORGN_CODE = 'FPRREQA_ORGN_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ACCT_CODE = 'FPRREQA_ACCT_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_PROG_CODE = 'FPRREQA_PROG_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ACTV_CODE = 'FPRREQA_ACTV_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_LOCN_CODE = 'FPRREQA_LOCN_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_SUSP_IND = 'FPRREQA_SUSP_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_NSF_SUSP_IND = 'FPRREQA_NSF_SUSP_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CANCEL_IND = 'FPRREQA_CANCEL_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CANCEL_DATE = 'FPRREQA_CANCEL_DATE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_PROJ_CODE = 'FPRREQA_PROJ_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_APPR_IND = 'FPRREQA_APPR_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_NSF_OVERRIDE_IND = 'FPRREQA_NSF_OVERRIDE_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ABAL_IND = 'FPRREQA_ABAL_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CONVERTED_AMT = 'FPRREQA_CONVERTED_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CLOSED_IND = 'FPRREQA_CLOSED_IND'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_DISC_AMT = 'FPRREQA_DISC_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_TAX_AMT = 'FPRREQA_TAX_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ADDL_CHRG_AMT = 'FPRREQA_ADDL_CHRG_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CONVERT_DISC_AMT = 'FPRREQA_CONVERT_DISC_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CONVERT_TAX_AMT = 'FPRREQA_CONVERT_TAX_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_CONVERT_ADDL_CHRG_AMT = 'FPRREQA_CONVERT_ADDL_CHRG_AMT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_DISC_AMT_PCT = 'FPRREQA_DISC_AMT_PCT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ADDL_AMT_PCT = 'FPRREQA_ADDL_AMT_PCT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_TAX_AMT_PCT = 'FPRREQA_TAX_AMT_PCT'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_DISC_RUCL_CODE = 'FPRREQA_DISC_RUCL_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_TAX_RUCL_CODE = 'FPRREQA_TAX_RUCL_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_ADDL_RUCL_CODE = 'FPRREQA_ADDL_RUCL_CODE'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_RUCL_CODE_LIQ = 'FPRREQA_RUCL_CODE_LIQ'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_VERSION = 'FPRREQA_VERSION'
    static final String REQ_ACC_FIELD_COPY_FPRREQA_DATA_ORIGIN = 'FPRREQA_DATA_ORIGIN'
    ...
    static final String FINANCE_PO_STATUS_EXTENSION_NAMED_QUERY_FIND_BY_POHD_CODE = 'FinancePOStatusExtension.fetchByPOHDCode'
    ...
    static final String FINANCE_PO_STATUS_EXTENSION_CONVERTED_TO_PO_PENDING = 'purchaseRequisition.status.convertedToPo.pendingApproval'
    static final String FINANCE_PO_STATUS_EXTENSION_CONVERTED_TO_PO_COMPLETED = 'purchaseRequisition.status.convertedToPo.completed'
    static final String FINANCE_PO_STATUS_EXTENSION_CONVERTED_TO_PO_DRAFT = 'purchaseRequisition.status.convertedToPo.draft'
    /** Constants for Domain FinanceRequestPOVerification **/
    static final String FTVRQPO_TABLE = 'FTVRQPO'

    static final String FINANCE_REQUEST_PO_VERIFICATION_NAMED_QUERY_FIND_BY_REQ_CODE = 'FinanceRequestPOVerification.fetchByRequestCode'
